    ...
    return createPortal(
        <>
            {/* Floating toggle button — left side per IL convention.
                Mobile (<lg): bottom offset is safe-area-aware so the button
                clears the StickyMobileCTA bar and the iPhone home indicator,
                while staying horizontally opposite the right-side ScrollToTop.
            ...
            <button
                ...
                className="fixed bottom-[calc(6rem+env(safe-area-inset-bottom))] left-4 lg:bottom-6 lg:left-5 inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#1B6FB6] text-white shadow-[0_12px_28px_-10px_rgba(27,111,182,0.6)] ring-2 ring-white hover:bg-[#155890] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#1B6FB6]/40 transition-colors"
            >
